    ...
    <div className="space-y-1.5">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 text-xs px-3 py-1.5 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-200 focus:border-violet-400 transition-colors"
        />
  ...
  return (
    <Card>
      <CardContent className="p-0 flex items-stretch">
        <div className="w-10 flex flex-col items-center justify-start pt-4 gap-2 bg-slate-50 border-r border-slate-100 shrink-0">
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pb-10">
        <Card>
          <CardHeader>
            <h2 className="text-sm font-semibold text-slate-900">Datos del cuestionario</h2>
          </CardHeader>
